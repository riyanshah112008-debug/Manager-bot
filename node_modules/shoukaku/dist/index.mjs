...
var Node = class extends TypedEventEmitter {
  ...
  async connect() {
    ...
    if (this.state === 1 /* CONNECTED */ || this.state === 0 /* CONNECTING */)
      return;
    ...
    const createConnection = () => {
      ...
      server.on("message", (data) => void this.message(data).catch((error) => this.error(error)));
