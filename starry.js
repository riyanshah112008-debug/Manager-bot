...
module.exports = (client) => {
    client.on('messageCreate', async (message) => {
        ...
        if (text.startsWith('.imagine ')) {
            ...
            // THE FIX: Added .catch(() => null) to prevent crashes if she can't speak in this channel
            const replyMsg = await message.reply('🎨 Painting your picture...').catch(() => null);
            
            // If Discord blocked the message, replyMsg is null. We just stop here.
            if (!replyMsg) return; 
            ...
            try {
                ...
                // Added .catch to the final image delivery just in case!
