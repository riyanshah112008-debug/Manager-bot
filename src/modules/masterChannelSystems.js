...
async function provisionMasterServerStructure(interaction, client, ownerPrompt) {
    ...
    const ticketCh = await guild.channels.create({
        ...
        type: ChannelType.GuildText,
        parent: supportCat.id,
        topic: 'Click to open a private support ticket or apply for staff position.',
    ...
    const ticketEmbed = new EmbedBuilder()
        ...
        .setDescription('Need help or have questions? Click below to open a ticket.')
...
async function handlePolicyVoteButtons(interaction) {
    ...
    // FIX FOR CODACY LINE 574: Explicit string casting to prevent NoSQL Injection
