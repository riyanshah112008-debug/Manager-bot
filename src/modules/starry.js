        ...
        if (isImageRequest) {
            ...
            try {
                ...
                await message.reply({ 
                    ...
                    files: [{ attachment: imageUrl, name: 'Starry_AI_Art.png' }] 
                }).catch(() => {});
            ...
            while (attempts < 4) {
                try {
                    ...
                    if (apiError.status === 503 && attempts < 4) {
                        if (attempts === 3) selectedModel = fallbackModel; // Model Pivot on heavy load
