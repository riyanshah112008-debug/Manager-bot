...
const dbPath = path.join(__dirname, 'modSettings.json');
...
module.exports = (client) => {
    ...
    client.on('interactionCreate', async (interaction) => {
        ...
        // 👑 THE GUARD: Verify if they have Admin OR are the Bot Creator via Environment Variables
